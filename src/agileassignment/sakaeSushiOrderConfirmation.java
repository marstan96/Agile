...
ArrayList<menu> list = new ArrayList<menu>();
    ...
    public ArrayList ListMenu(){
        ...
        menu menu2 = new menu("Sachi Set",22.00,1);
        menu menu3 = new menu("Salmon Zukushi",23.00,1);
        menu menu4 = new menu("Salmon Treasures",28.00,1);
        menu menu5 = new menu("Fuku Set",35.00,1);
        list.add(menu1);
        list.add(menu2);
        list.add(menu3);
        list.add(menu4);
