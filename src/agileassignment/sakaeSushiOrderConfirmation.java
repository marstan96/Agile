 ...
 * @author Asus
 */
public class sakaeSushiOrderConfirmation extends javax.swing.JFrame {
     ...
     */
    public sakaeSushiOrderConfirmation() {
        initComponents();
        addRowToJTable();
    }

    public ArrayList ListMenu() {
        menu menu1 = new menu("Mentai Zukushi", 11.00, 1);
        menu menu2 = new menu("Golden Ball Salmon Trio Mayo", 11.00, 1);
        menu menu3 = new menu("Jyo Unagi", 12.00, 1);
        list.add(menu1);
        list.add(menu2);
        list.add(menu3);
        return list;
    ...
    public void addRowToJTable() {
        DefaultTableModel model = (DefaultTableModel) sakaeSushiTable.getModel();
    ...
    private void initComponents() {
        ...
        sakaeSushiTable = new javax.swing.JTable();
        ...
        sakaeSushiTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(sakaeSushiTable);
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        ...
        if (reply == JOptionPane.YES_OPTION) {
            if (sakaeSushiTable.getSelectedRow() != -1) {

                model.removeRow(sakaeSushiTable.getSelectedRow());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sakaeSushiOrderConfirmation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sakaeSushiOrderConfirmation().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTable sakaeSushiTable;
