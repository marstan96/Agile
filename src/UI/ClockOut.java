 ...
 * @author renmi
 */
public class ClockOut extends javax.swing.JFrame {
...
//        clockIn.add(jcbStaffId.getSelectedItem().toString());
        if(jcbStaffId.toString().equals("ST001") || jpfPassword.getText().equals("ST001"))
        {
        jtaClock.setText(null);
...
//        clockIn.remove("John");
        clockOut.add("John");
            ...
            jtaClock.setText("Password and ID does not fit");
        System.out.print(""+jpfPassword.getText());
